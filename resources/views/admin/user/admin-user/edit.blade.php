                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="">نام</label>
                                    <input name="first_name" type="text" value="{{ old('first_name',$admin->first_name) }}" class="form-control form-control-sm">
                                </div>
                                @error('first_name')
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="last_name" type="text" value="{{ old('last_name',$admin->last_name) }}" class="form-control form-control-sm">
                                </div>
                                @error('last_name')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset($admin->profile_photo_path) }}" alt="" width="100" height="50" class="mt-3 border" >
                                </div>
                                @error('image')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>
