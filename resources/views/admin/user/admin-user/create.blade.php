                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="">نام</label>
                                    <input name="first_name" type="text" value="{{ old('first_name') }}" class="form-control form-control-sm">
                                </div>
                                @error('first_name')
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="last_name" type="text" value="{{ old('last_name') }}" class="form-control form-control-sm">
                                </div>
                                @error('last_name')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="email" type="text" value="{{ old('email') }}" class="form-control form-control-sm">
                                </div>
                                @error('email')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="mobile" type="text" value="{{ old('mobile') }}" class="form-control form-control-sm">
                                </div>
                                @error('mobile')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>
