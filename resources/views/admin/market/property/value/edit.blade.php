...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item font-size-12"> <a href="#">ویرایش مقدار فرم کالا</a></li>
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <select name="type" id="" class="form-control form-control-sm" id="status">
                                    <option value="0" @if (old('type', $value->type) == 0) selected @endif>غیرفعال</option>
                                    <option value="1" @if (old('type', $value->type) == 1) selected @endif>فعال</option>
                                </select>
                            </div>
                            @error('type')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
