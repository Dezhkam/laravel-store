                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            </td>                            <td>{{ $product->marketable_number }}</td>
                            ...
                            <td class="width-22-rem text-left">
                                ...
                                <a href="{{ route('admin.market.store.edit',$product->id) }}" class="btn btn-warning btn-sm ">
                                    <i class="fa fa-trash-alt"></i> اصلاح موجودی</a>
                            </td>
                        </tr>
                        @endforeach
